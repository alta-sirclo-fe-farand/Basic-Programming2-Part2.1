## BASIC PROGRAMMING 2 PART 1

clone project ini dengan cara

```
git clone https://github.com/FE-Sirclo/Basic-Programming2-Part1.git
```
...
buat repository pada github organization kalian dengan format: `Basic-Programming2-Part1`
